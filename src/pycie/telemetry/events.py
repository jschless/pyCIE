...
class EventType(StrEnum):
    ...
    FIB_DROP = "FIB_DROP"
    BGP_SESSION_CHANGE = "BGP_SESSION_CHANGE"
    BGP_OPEN_RX = "BGP_OPEN_RX"
    BGP_UPDATE_RX = "BGP_UPDATE_RX"
    BGP_BEST_PATH = "BGP_BEST_PATH"
    BGP_UPDATE_EXPORT = "BGP_UPDATE_EXPORT"
    OSPF_HELLO_RX = "OSPF_HELLO_RX"
    OSPF_NEIGHBOR_CHANGE = "OSPF_NEIGHBOR_CHANGE"
    OSPF_LSA_INSTALL = "OSPF_LSA_INSTALL"
    OSPF_SPF_RUN = "OSPF_SPF_RUN"
    ISIS_LSP_INSTALL = "ISIS_LSP_INSTALL"
    ISIS_SPF_RUN = "ISIS_SPF_RUN"
    NAT_SESSION_CREATE = "NAT_SESSION_CREATE"
    NAT_TRANSLATE_OUTBOUND = "NAT_TRANSLATE_OUTBOUND"
    NAT_TRANSLATE_INBOUND = "NAT_TRANSLATE_INBOUND"
    NAT_SESSION_EXPIRE = "NAT_SESSION_EXPIRE"
    ACL_EVALUATE = "ACL_EVALUATE"
    QOS_REMARK = "QOS_REMARK"
    QOS_ENQUEUE = "QOS_ENQUEUE"
    QOS_DEQUEUE = "QOS_DEQUEUE"
    ARP_CACHE_LEARN = "ARP_CACHE_LEARN"
    ARP_REQUEST_RX = "ARP_REQUEST_RX"
    ARP_REPLY_TX = "ARP_REPLY_TX"
    BFD_CONTROL_RX = "BFD_CONTROL_RX"
    BFD_CONTROL_TX = "BFD_CONTROL_TX"
    BFD_STATE_CHANGE = "BFD_STATE_CHANGE"
    BFD_TIMEOUT = "BFD_TIMEOUT"
    IPSEC_POLICY_EVALUATE = "IPSEC_POLICY_EVALUATE"
    IPSEC_SA_LOOKUP = "IPSEC_SA_LOOKUP"
    RIB_CANDIDATE_EVALUATE = "RIB_CANDIDATE_EVALUATE"
    RIB_ROUTE_INSTALL = "RIB_ROUTE_INSTALL"
    RIB_ROUTE_SKIP = "RIB_ROUTE_SKIP"
